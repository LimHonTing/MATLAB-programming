...
rng('default');
%seed 496, 966, 570
%seed 496 sel= 0.2 mul= 0.35
%seed 966 sel= 0.3 mul= 0.3
%seed 570 sel= 0.4 mul= 0.2
rng(570);

% load dataset
data = readmatrix("ecoli.csv");
...
mutrate = 0.2; % MutationRate
progress = [];


%initialize maximum hidden layer and hidden layer units
%seed 496, 6 hidden layer, 12 hidden layer units
%seed 966  6 hidden layer, 12 hidden layer units
%seed 570 6 hidden layer, 12 hidden layer units
max_hidden = 6;
max_hidden_un = 12;
